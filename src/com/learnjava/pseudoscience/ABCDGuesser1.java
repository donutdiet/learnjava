...
public final class ABCDGuesser1 {
     ...
     *
     * @requires user input from the console; SimpleReader, SimpleWriter
     *
     * @ensures <pre>
     * returns the first positive double input by the user
     * </pre>
     */
     ...
     *
     * @ensures <pre>
     * returns the first positive double (not equal to one) input by the user
     * </pre>
     */
    ...
    public static void main(String[] args) {
        ...
        while (indexW < constants.length) {
            indexX = 0;
            while (indexX < constants.length) {
                indexY = 0;
                while (indexY < constants.length) {
                    indexZ = 0;
                    while (indexZ < constants.length) {
